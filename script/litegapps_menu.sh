...
menu_about(){
	...
	print " "
	print "${Y}2. Change Device Props ${WHITE}"
	print " Change your device props fingerprint"
	print " "
	print "${Y}3. Fix${WHITE}"
	print " Tools Fixing"
	print " "
	print "${Y}4. Install ZIP Packages${WHITE}"
	print " You can install even more than one zip package!  offline.  put package.zip into /sdcard/Android/litegapps/package"
	print " "
	print "${Y}5. Settings${WHITE}"
	print "Settings "
	print " "
	print "${Y}6. Tools${WHITE}"
	print "Tools "
	print " "
	print "${Y}7. Updater${WHITE}"
